...
stopwords_file_name = "kz-stopwords" #input("Name of the stop-words file: ") #"stop_words.txt"

affixes_file_name = "affixes.xls" #input("Name of the affix file: ") #"affixes.xls"
affixes = sorting_affixes(affixes_file_name)
#print(affixes)

text_file_name = "exp1000.kk" #input("Name of the text file: ") #"text.txt"
stems_file_name = "kz-truestems.txt" #input("Name of the vocabulary of correct stems: ") #"truestems.txt"
...
output_file_name = "results1.xls" #input("Name of the output file (result): ") #"results.xls"
