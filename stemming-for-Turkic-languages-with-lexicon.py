...
stopwords_file_name = "stop_words.txt" #input("Name of the stop-words file: ") #"stop_words.txt"

affixes_file_name = "affixes.xls" #input("Name of the affix file: ") #"affixes.xls"
affixes = sorting_affixes(affixes_file_name)
#print(affixes)

text_file_name = "text.txt" #input("Name of the text file: ") #"text.txt"
stems_file_name = "truestems.txt" #input("Name of the vocabulary of correct stems: ") #"truestems.txt"
